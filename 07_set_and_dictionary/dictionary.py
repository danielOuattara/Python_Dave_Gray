...
#  Delete K-V pair and Clear dict

band['drums'] = 'Bonham'  # Add a new K-V pair again
...
band_3 = band  # does not create a copy BUT create a reference in memory
print(band)
print(band_3)
...
print("band['member_1'] = ", band['member_1'])  # member_1 dictionary
